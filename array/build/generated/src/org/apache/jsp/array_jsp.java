...
public final class array_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for (int j = 0;j<3 ; j++)  { 
      out.write(" <hr>\n");
      out.write("            <br>Name : ");
      out.print( productNames[j] );
      out.write("\n");
      out.write("            <br>Description : ");
      out.print( productDescriptions[j] );
      out.write("\n");
      out.write("            <br> Price : ");
      out.print( productPrices[j] );
      out.write("\n");
      out.write("            <br> In Order : ");
      out.print( orderedQuantities[j] );
      out.write("\n");
      out.write("            <br> In Stock : ");
      out.print( inStockQuantities[j] );
      out.write("\n");
      out.write("            \n");
      out.write("            ");
 }
